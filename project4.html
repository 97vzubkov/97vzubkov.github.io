      ...
      <div class="wrapper">
                  ...
                  <div class="hero-content">
                        ...
                        <div class="row">
                              <div class="col-lg-12">
                                    ...
                                    <h1 class="wow fadeInUp" data-wow-delay="1s">Customer perception towards alternative fuel cars</h1><br><br>

                                    <div class="row">
                                          <div class="col-lg-4">
                                                <p class="wow fadeInUp" data-wow-delay="1.2s">service :</p>
                                                <h6 class="wow fadeInUp" data-wow-delay="1.3s">Web scraping/Deep Learning/NLP</h6>
                                          </div>

                                          <div class="col-lg-4">
                                                <p class="wow fadeInUp" data-wow-delay="1.4s">started :</p>
                                                <h6 class="wow fadeInUp" data-wow-delay="1.5s">15 May 2020</h6>
                                          </div>

                                          <div class="col-lg-4">
                                                <p class="wow fadeInUp" data-wow-delay="1.6s">completed :</p>
                                                <h6 class="wow fadeInUp" data-wow-delay="1.7s"> 1 September 2020</h6>
                                          </div>
                                    </div>
                                    <br>
                                    <p class="wow fadeInUp" data-wow-delay="1.8s">The automotive industry is currently in a transition phase in which new disruptive technologies and changes in customer behaviours are the main drivers to a new era. In particular, one of the main changes regards the switch to alternative fuelled cars. The project aims to analyse textual data to develop an understanding of the evolution of the general puclic perception towards electric and hybrid cars.</p>
                              </div>
                        </div>
                        <div class="row">
            ...
            <div class="project-img">
                  <div class="container">
                        ...
                        <div class="row">
                              <div class="col-md-8">
                                    <div class="project image4 wow fadeInUp" data-wow-delay="0.8s"></div>
                              </div>
                              <div class="col-md-4">
                                    <div class="project image4 wow fadeInUp" data-wow-delay="0.8s"></div>
                              </div>
                  ...
                  <div class="container">
                        <div class="row">
                              <div class="col-lg-6 prev">
                                    <a href="project3.html"><ion-icon name="arrow-back"></ion-icon>previous</a>
                              </div>
                              <div class="col-lg-8 next">
                                    <a href="project5.html"><ion-icon name="arrow-forward"></ion-icon>next</a>
                              </div>
                        </div>
                  </div>
            </div>
