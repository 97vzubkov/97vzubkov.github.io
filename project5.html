      ...
      <div class="wrapper">
                  ...
                  <div class="hero-content">
                        ...
                        <div class="row">
                              <div class="col-lg-12">
                                    ...
                                    <h1 class="wow fadeInUp" data-wow-delay="1s">Network analysis of Stack Overflow</h1><br><br>

                                    <div class="row">
                                          <div class="col-lg-4">
                                                <p class="wow fadeInUp" data-wow-delay="1.2s">service :</p>
                                                <h6 class="wow fadeInUp" data-wow-delay="1.3s">Network analysis</h6>
                                          </div>
                                    ...
                                    <br>
                                    <p class="wow fadeInUp" data-wow-delay="1.8s">This project aims to analyse the reason why users in Stack Overflow participate in certain threads. Having a deeper insight into how links formed among users and communities during time is helpful to handle possible business problems emerged such as explaining the popularity of products in online marketplaces or building recommendation system.</p>
                              </div>
                        </div>
                        <div class="row">
            ...
            <div class="project-img">
                  <div class="container">
                        ...
                        <div class="row">
                              <div class="col-md-8">
                                    <div class="project image5 wow fadeInUp" data-wow-delay="0.8s"></div>
                              </div>
                              <div class="col-md-4">
                                    <div class="project image5 wow fadeInUp" data-wow-delay="0.8s"></div>
                              </div>
                  ...
                  <div class="container">
                        <div class="row">
                              <div class="col-lg-6 prev">
                                    <a href="project4.html"><ion-icon name="arrow-back"></ion-icon>previous</a>
                              </div>
                              <div class="col-lg-8 next">
                                    <a href="project6.html"><ion-icon name="arrow-forward"></ion-icon>next</a>
                              </div>
                        </div>
                  </div>
            </div>
