      ...
      <div class="wrapper">
                  ...
                  <div class="hero-content">
                        ...
                        <div class="row">
                              <div class="col-lg-12">
                                    ...
                                    <h1 class="wow fadeInUp" data-wow-delay="1s">Uber vs. Yellow taxi analysis of competitiveness</h1><br><br>

                                    <div class="row">
                                          <div class="col-lg-4">
                                                <p class="wow fadeInUp" data-wow-delay="1.2s">service :</p>
                                                <h6 class="wow fadeInUp" data-wow-delay="1.3s">Python dashboard data visualisations</h6>
                                          </div>

                                          <div class="col-lg-4">
                                                <p class="wow fadeInUp" data-wow-delay="1.4s">started :</p>
                                                <h6 class="wow fadeInUp" data-wow-delay="1.5s">20 November 2019</h6>
                                          </div>

                                          <div class="col-lg-4">
                                                <p class="wow fadeInUp" data-wow-delay="1.6s">completed :</p>
                                                <h6 class="wow fadeInUp" data-wow-delay="1.7s"> 10 December 2019</h6>
                                          </div>
                                    </div>
                                    <br>
                                    <p class="wow fadeInUp" data-wow-delay="1.8s">This project aims to analyse the competition between Uber Technologies Inc. (Uber) and New York City's Medallion (Yellow) taxi cabs companies in the New York City. The targeted audience is the association of the yellow taxi drivers 
                                          for whom project aims to show how their competitors in face of Uber company acquired the market traction over time and in 
                                          which areas they mostly operate. Additional factors like weather and time are included to explore the demand, key 
                                          differences and highlight where Yellow Taxi could improve to stay competitive.</p>
                              </div>
                        </div>
                        <div class="row">
            ...
            <div class="project-img">
                  <div class="container">
                        ...
                        <div class="row">
                              <div class="col-md-8">
                                    <div class="project image2 wow fadeInUp" data-wow-delay="0.8s"></div>
                              </div>
                              <div class="col-md-4">
                                    <div class="project image2 wow fadeInUp" data-wow-delay="0.8s"></div>
                              </div>
                  ...
                  <div class="container">
                        <div class="row">
                              <div class="col-lg-6 prev">
                                    <a href="project1.html"><ion-icon name="arrow-back"></ion-icon>previous</a>
                              </div>
                              <div class="col-lg-8 next">
                                    <a href="project3.html"><ion-icon name="arrow-forward"></ion-icon>next</a>
                              </div>
                        </div>
                  </div>
            </div>
