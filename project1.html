      ...
      <div class="wrapper">
                  ...
                  <div class="hero-content">
                        ...
                        <div class="row">
                              <div class="col-lg-12">
                                    ...
                                    <h1 class="wow fadeInUp" data-wow-delay="1s">Data Management on NBA game case</h1><br><br>

                                    <div class="row">
                                          <div class="col-lg-4">
                                                <p class="wow fadeInUp" data-wow-delay="1.2s">service :</p>
                                                <h6 class="wow fadeInUp" data-wow-delay="1.3s">Data engineering</h6>
                                          </div>

                                          <div class="col-lg-4">
                                                <p class="wow fadeInUp" data-wow-delay="1.4s">started :</p>
                                                <h6 class="wow fadeInUp" data-wow-delay="1.5s">17 June 2020</h6>
                                          </div>

                                          <div class="col-lg-4">
                                                <p class="wow fadeInUp" data-wow-delay="1.6s">completed :</p>
                                                <h6 class="wow fadeInUp" data-wow-delay="1.7s"> 1 July 2020</h6>
                                          </div>
                                    </div>
                                    <br>
                                    <p class="wow fadeInUp" data-wow-delay="1.8s">The aim of this project was to store, clean and manipulate raw data using MongoDB, a schema-free database especially useful with evolving streams of data. The results will help to get initial insights on data, make it more structured and prepared for deeper analysis. The data have been gathered by twitter during 3rd game of the 2018 NBA Finals between Cleveland Cavaliers and Golden State Warriors.</p>
                              </div>
                        </div>
                        <div class="row">
            ...
            <div class="project-img">
                  <div class="container">
                        ...
                        <div class="row">
                              <div class="col-md-8">
                                    <div class="project image1 wow fadeInUp" data-wow-delay="0.8s"></div>
                              </div>
                              <div class="col-md-4">
                                    <div class="project image1 wow fadeInUp" data-wow-delay="0.8s"></div>
                              </div>
                  ...
                  <div class="container">
                        <div class="row">
                              <div class="col-lg-6 prev">
                                    <a href="project6.html"><ion-icon name="arrow-back"></ion-icon>previous</a>
                              </div>
                              <div class="col-lg-8 next">
                                    <a href="project2.html"><ion-icon name="arrow-forward"></ion-icon>next</a>
                              </div>
                        </div>
                  </div>
            </div>
