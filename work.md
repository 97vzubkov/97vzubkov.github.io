      ...
      <div class="wrapper">
                  ...
                  <div class="hero-content">
                        ...
                        <div class="row">
                              <div class="col-lg-8">
                                    ...
                                    <h3 class="wow fadeInUp" data-wow-delay="1s">projects.</h3><br>
                                    <p class="wow fadeInUp" data-wow-delay="1.2s">I am keen on analysing the data with an attention to the details and data complexity. Some of my favorite projects are presented on this page in which I tried to disassemble the problem completely, as well as to improve myself as a specialist in a particular area. This portfolio presents works on such actual fields in <b>Data Science</b> as Supervised and Unsupervised ML Techniques, Natural Language Processing, Cost Optimization Algorithms, Dashboard Data Visualisations, Network Analytics and Data Engineering Pipelines. </p>
            ...
            <div class="container-fluid">
                  ...
                  <div class="row">
                        ...
                        <div class="col-lg-4 project project1 wow fadeInUp" data-wow-delay="1.4s" onclick="location.href='project1.html'"></div>
                  </div>

                  <div class="whitespace"></div>

                  <div class="row">
                        <div class="col-lg-6 project project2 wow fadeInUp" onclick="location.href='project2.html'"></div>
                  ...
                  <div class="row">
                        ...
                        <div class="col-lg-5 project project6 wow fadeInUp" onclick="location.href='project6.html'"></div>
