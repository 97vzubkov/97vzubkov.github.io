      ...
      <div class="wrapper">
                  ...
                  <div class="hero-content">
                        ...
                        <div class="row">
                              <div class="col-lg-12">
                                    ...
                                    <h1 class="wow fadeInUp" data-wow-delay="1s">New pricing strategy for airlines</h1><br><br>

                                    <div class="row">
                                          <div class="col-lg-4">
                                                <p class="wow fadeInUp" data-wow-delay="1.2s">service :</p>
                                                <h6 class="wow fadeInUp" data-wow-delay="1.3s">Dynamic and Linear programming (R programming language)</h6>
                                          </div>

                                          <div class="col-lg-4">
                                                <p class="wow fadeInUp" data-wow-delay="1.4s">started :</p>
                                                <h6 class="wow fadeInUp" data-wow-delay="1.5s">20 March 2020</h6>
                                          </div>

                                          <div class="col-lg-4">
                                                <p class="wow fadeInUp" data-wow-delay="1.6s">completed :</p>
                                                <h6 class="wow fadeInUp" data-wow-delay="1.7s"> 3 April 2020</h6>
                                          </div>
                                    </div>
                                    <br>
                                    <p class="wow fadeInUp" data-wow-delay="1.8s">The goal of this project is to review the existing pricing strategy for popular flights used by one of the leading low-cost air travel company Wizz Air and propose new strategies that will significantly increase the company's revenue. So far, Wizz Air adopts same pricing system to all air routes within the company, whereas revenue could be increased by differentiating revenue strategies between the highly demanded and less popular air flights. The analysis has been conducted on a popular flight from Budapest (BUD) to London Gatwick (LGW) using overbooking strategy and dynamic programming.</p>
                              </div>
                        </div>
            ...
            <div class="project-img">
                  <div class="container">
                        ...
                        <div class="row">
                              <div class="col-md-8">
                                    <div class="project image6 wow fadeInUp" data-wow-delay="0.8s"></div>
                              </div>
                              <div class="col-md-4">
                                    <div class="project image6 wow fadeInUp" data-wow-delay="0.8s"></div>
                              </div>
                  ...
                  <div class="container">
                        <div class="row">
                              <div class="col-lg-6 prev">
                                    <a href="project5.html"><ion-icon name="arrow-back"></ion-icon>previous</a>
                              </div>
                              <div class="col-lg-8 next">
                                    <a href="project1.html"><ion-icon name="arrow-forward"></ion-icon>next</a>
                              </div>
                        </div>
                  </div>
            </div>
